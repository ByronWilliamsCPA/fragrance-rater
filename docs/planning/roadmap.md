...
| P4 | Participant experience | Implementation in progress | P3 complete | Ordinary, calibration, recommendation, sampling, and outcome workflows usable without IDs or API tools |
...
1. Complete P4 participant workflows using synthetic data.
2. Continue non-UI P1 evidence: physical manifest, authorized fixtures, backup clone, migration,
   concurrency, and recovery.
3. Implement P5 manager/reporting workflows using demo data after P4 closes.
