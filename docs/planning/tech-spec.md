...
| :--- | :--- | :--- |
| Frontend | React 19, TypeScript, Vite | P3 foundation and P4 participant workflows implemented; P5-P6 complete manager, reporting, operational, and rehearsal workflows before F1 |
