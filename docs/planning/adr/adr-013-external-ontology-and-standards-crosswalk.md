...
> **Status**: Accepted; amends ADR-004, ADR-010; amended by ADR-015 (2026-09-24)
>
> **Date**: 2026-09-15

## 2026-09-24 amendment (pointer to ADR-015)

ADR-015 makes the project's olfactory vocabulary project-owned (`fr-core`) rather than
...
further extended by ADR-015 item 10, target generalized to `note_id` XOR `term_id`. See
ADR-015 for the full model.
...
- [ADR-015](adr-015-project-owned-faceted-olfactory-vocabulary.md): amends this ADR's Decision
