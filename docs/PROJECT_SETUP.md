...
git remote add origin https://github.com/ByronWilliamsCPA/fragrance-rater.git
...
Use Claude Code to generate detailed planning documents for your project:
...
3. **Enter your repository URL**: `https://github.com/ByronWilliamsCPA/fragrance_rater`
...
3. **Get your project key**: Should be `ByronWilliamsCPA_fragrance_rater`
