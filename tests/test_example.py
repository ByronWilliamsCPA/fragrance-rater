"""Example tests demonstrating best practices for Fragrance Rater.
...
class TestPackageInitialization:
    ...
    def test_package_author_exists(self) -> None:
        ...
        """
        from fragrance_rater import __author__, __email__
...
class TestLogging:
    ...
    def test_log_performance(self) -> None:
        ...
        from fragrance_rater.utils.logging import log_performance
...
class TestCLI:
    ...
    def test_cli_has_version(self) -> None:
        ...
        """
        from fragrance_rater.cli import cli
    ...
    def test_cli_config_command(self) -> None:
        ...
        assert "Project: Fragrance Rater" in result.output
    ...
    def test_cli_hello_error_handling(self) -> None:
        ...
        with patch("fragrance_rater.cli.logger") as mock_logger:
...
class TestExampleIntegration:
    ...
    def test_package_imports(self) -> None:
        ...
        import fragrance_rater

        assert hasattr(fragrance_rater, "__version__")

        # Test importing from submodules
        from fragrance_rater.utils import get_logger

        assert callable(get_logger)

        from fragrance_rater.core import Settings
