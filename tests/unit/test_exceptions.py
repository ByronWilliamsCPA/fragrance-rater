...
Fragrance Rater exception hierarchy, covering:
...
class TestProjectBaseError:
    ...
    def test_basic_initialization(self) -> None:
        ...
        from fragrance_rater.core.exceptions import ProjectBaseError
...
class TestConfigurationError:
    ...
    def test_initialization(self) -> None:
        ...
        from fragrance_rater.core.exceptions import ConfigurationError
...
class TestAuthenticationError:
    ...
    def test_default_message(self) -> None:
        ...
        from fragrance_rater.core.exceptions import AuthenticationError
...
class TestAuthorizationError:
    ...
    def test_default_message(self) -> None:
        """Verify default message is used when not provided."""
        from fragrance_rater.core.exceptions import AuthorizationError
...
class TestExternalServiceError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from fragrance_rater.core.exceptions import ExternalServiceError
...
class TestAPIError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from fragrance_rater.core.exceptions import APIError
...
class TestModuleExports:
    ...
    def test_all_exceptions_exported(self) -> None:
        ...
        from fragrance_rater.core import exceptions
