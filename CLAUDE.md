...
**Name**: Fragrance Rater
**Description**: Personal fragrance evaluation and recommendation system for family use with LLM-powered recommendations
**Author**: Byron Williams <byron@williamshome.family>
**Repository**: https://github.com/ByronWilliamsCPA/fragrance-rater
**Created**: 2025-12-28
...
> **Status**: P0 and P2 complete; P3 implementation is ready for review, while P1 evidence and
> P4-P6 product UI gates precede F1 family perfume testing. The project plan owns
> milestone status.
...
docker build -t fragrance_rater .  # Build production image
```
...
- Logging: Structured logging via `src/fragrance_rater/utils/logging.py`
- Error Handling: Custom exceptions in `src/fragrance_rater/core/exceptions.py`
- Correlation: Request tracing via `src/fragrance_rater/middleware/correlation.py`
### Exception Hierarchy
...
```python
from fragrance_rater.utils.logging import setup_logging, get_logger
...
../fragrance_rater-worktrees/

# Quick reference commands
git worktree add ../fragrance_rater-worktrees/feature-name -b feature/feature-name
git worktree add ../fragrance_rater-worktrees/pr-42 origin/feature/pr-branch
git worktree list
git worktree remove ../fragrance_rater-worktrees/feature-name
```
