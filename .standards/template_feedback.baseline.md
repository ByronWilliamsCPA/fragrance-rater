...
- `fragrance_rater/path/to/file.ext`
...
`fragrance_rater/.github/workflows/`.

**Affected Files**:
- `fragrance_rater/.github/workflows/ci.yml`
- `fragrance_rater/.github/workflows/release.yml`
- `fragrance_rater/.github/workflows/docs.yml`
