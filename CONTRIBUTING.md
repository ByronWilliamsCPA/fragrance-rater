# Contributing to Fragrance Rater

Thank you for your interest in contributing to Fragrance Rater! This document provides guidelines and instructions for contributing to the project.
...
import pytest
from pathlib import Path
from fragrance_rater.core import YourModule
...
- **General Questions**: Open a [GitHub Discussion](https://github.com/ByronWilliamsCPA/fragrance-rater/discussions)
- **Bug Reports**: Open a [GitHub Issue](https://github.com/ByronWilliamsCPA/fragrance-rater/issues)
...
Thank you for contributing to Fragrance Rater!
