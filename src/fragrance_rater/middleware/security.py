...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        Args:
            ...
            call_next: ASGI downstream handler.

        Returns:
            The downstream response with security headers applied.
        """
...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        Returns:
            Either the downstream response or a 429 rate-limit response.
        """
...
class SSRFPreventionMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        Returns:
            Either the downstream response or a 400 Bad Request if a
