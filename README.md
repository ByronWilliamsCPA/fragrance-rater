...
## Quality & Security
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/ByronWilliamsCPA/fragrance_rater/badge)](https://securityscorecards.dev/viewer/?uri=github.com/ByronWilliamsCPA/fragrance_rater)
[![codecov](https://codecov.io/gh/ByronWilliamsCPA/fragrance_rater/graph/badge.svg)](https://codecov.io/gh/ByronWilliamsCPA/fragrance_rater)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ByronWilliamsCPA_fragrance_rater&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=ByronWilliamsCPA_fragrance_rater)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=ByronWilliamsCPA_fragrance_rater&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=ByronWilliamsCPA_fragrance_rater)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=ByronWilliamsCPA_fragrance_rater&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=ByronWilliamsCPA_fragrance_rater)
[![REUSE Compliance](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/reuse.yml/badge.svg)](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/reuse.yml)

## CI/CD Status
[![CI Pipeline](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/ci.yml?query=branch%3Amain)
[![Security Analysis](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/security-analysis.yml/badge.svg?branch=main)](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/security-analysis.yml?query=branch%3Amain)
[![Documentation](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/docs.yml/badge.svg?branch=main)](https://github.com/ByronWilliamsCPA/fragrance_rater/actions/workflows/docs.yml?query=branch%3Amain)
...
| **Created** | 2025-12-28 |
| **Repository** | [ByronWilliamsCPA/fragrance-rater](https://github.com/ByronWilliamsCPA/fragrance-rater) |
...
```bash
# Clone repository
git clone https://github.com/ByronWilliamsCPA/fragrance-rater.git
cd fragrance_rater
...
from fragrance_rater import YourModule
...
```bash
# Display help
uv run fragrance-rater --help

# Use the CLI tool
uv run fragrance-rater command --option value

# Example: Process input file
uv run fragrance-rater process input.txt --output result.json
```
...
```bash
# Start backend first
uv run uvicorn fragrance_rater.main:app &
...
# Run with coverage
uv run pytest --cov=fragrance_rater --cov-report=html
...
uv run pytest --cov=fragrance_rater --cov-report=term-missing
...
```
fragrance_rater/
├── src/fragrance_rater/     # Main package
│   ├── __init__.py
...
uv run pytest --cov=fragrance_rater --cov-fail-under=80
```
...
- **Issues**: [GitHub Issues](https://github.com/ByronWilliamsCPA/fragrance-rater/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ByronWilliamsCPA/fragrance-rater/discussions)
