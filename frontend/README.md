# Fragrance Rater Frontend

React + TypeScript frontend for Fragrance Rater.
...
cd .. && uv run uvicorn fragrance_rater.main:app &
...
docker build -t fragrance_rater-frontend .

# Run with custom API URL
docker run -p 80:80 \
  --build-arg VITE_API_URL=https://api.example.com \
  fragrance_rater-frontend
```
